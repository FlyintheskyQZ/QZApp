...
public class ReportDisplayOperation {


    public void getBriefReportItems(final String user_id, final Handler handler, final Context context) {
        new Timer().schedule(new TimerTask() {
            @Override
            public void run() {
                Message message = new Message();
                List<BriefReportItem> list = null;
                ...
                try {
                    ...
                    if(responseBody == null || responseBody.isEmpty()){
                        ...
                        list = gson.fromJson(responseBody, new TypeToken<List<BriefReportItem>>(){}.getType());
