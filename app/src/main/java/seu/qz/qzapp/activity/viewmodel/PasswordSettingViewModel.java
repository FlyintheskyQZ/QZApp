...
import seu.qz.qzapp.activity.operation.PasswordSettingOperation;
import seu.qz.qzapp.database.LitePalUtils;
import seu.qz.qzapp.entity.AppCustomer;
import seu.qz.qzapp.entity.BriefOrderItem;

public class PasswordSettingViewModel extends ViewModel {

    private PasswordSettingOperation operation = new PasswordSettingOperation();
            ...
            public void handleMessage(@NonNull Message msg) {
                switch (msg.what){
                    ...
                    case 2:
                        ...
                        dialog_success.setTitle(R.string.passwordsetting_updateSuccess_title);
                        dialog_success.setMessage(R.string.passwordsetting_updateSuccess_message);
                        dialog_success.setCancelable(false);
                        dialog_success.setPositiveButton(R.string.passwordsetting_updateSuccess_positive, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
